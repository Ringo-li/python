let vm = new Vue({
    ...
    methods: {
		...
		generate_image_code: function(){
			...
			this.image_code_url = "/imagecode/" + this.image_code_id + "/";
        ...
        check_phone: function () {
            ...
            if (this.error_phone == false) {
                var url = '/mobiles/' + this.mobile + '/count/';
                axios.get(url, {
                    responseType: 'json',
                     withCredentials:true,
                })
        ...
        send_sms_code: function () {
            ...
            var url = '/sms_codes/' + this.mobile + '/' + '?image_code=' + this.image_code
        ...
        on_submit: function () {
            ...
            // 点击注册按钮之后, 发送请求 (下面的代码是通过请求体传参的)   && this.error_sms_code == false
            if (this.error_name == false && this.error_password == false && this.error_check_password == false
                && this.error_phone == false && this.error_allow == false && this.error_sms_code == false) {
                axios.post('/register/', {
